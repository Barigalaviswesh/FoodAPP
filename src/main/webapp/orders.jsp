...
<%@ page import="java.util.*, com.foodapp.model.Orderhistory, com.foodapp.model.User, com.foodapp.daoimpl.OrderhistoryDAOImpl" %>
...
<div class="container">
    ...
    <%
        ...
        if (user != null) {
            ...
            List<Orderhistory> orders = orderHistoryDAO.fetchOrderHistoryByUserId(user.getUser_id());
    ...
    <div class="order-card">
        <div class="order-header">
            <div>
                ...
                <div class="order-date">
                    <%= order.getDate() != null ? order.getDate().toString() : "Date not available" %>
                </div>
            </div>
        ...
        <div class="order-details">
            <div>
                <div style="font-size: 14px; color: #686b78; margin-bottom: 5px;">Total Amount</div>
    ...
    <div class="empty-orders">
        <h2>No orders yet</h2>
        <p>Start ordering delicious food from our restaurants!</p>
